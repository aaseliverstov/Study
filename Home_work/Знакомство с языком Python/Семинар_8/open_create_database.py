...
def add_data_tabel1(cur):
    staff = [
        ('1', 'Stephanie', 'Stewart', 'female', '01.02.1990', 'married', 'khabarovsk karla-marksa 1', 'driver'), 
        ('2', 'Sincere', 'Sherman', 'female', '10.02.1991', 'married', 'moscov karla-marksa 1', 'driver'), 
        ('3', 'Sidney', 'Horn', 'male', '01.03.1985', 'not married', 'st petersberg karla-marksa 1', 'conductor'), 
        ('4', 'Litzy', 'Yates', 'female', '11.05.1995', 'not married', 'moscov karla-marksa 1', 'conductor'), 
        ('5', 'Jaxon', 'Mills', 'male', '06.02.2000', 'married', 'Novosibirsk karla-marksa 1', 'controller'), 
        ('6', 'Paul', 'Richard', 'male', '02.04.1991', 'married', 'Kazan karla-marksa 1', 'controller'), 
        ('7', 'Kamari', 'Holden', 'female', '01.07.1990', 'married', 'Chelyabinsk karla-marksa 1', 'engineer'), 
        ('8', 'Gaige', 'Summers', 'female', '25.02.1992', 'married', 'samara karla-marksa 1', 'engineer'), 
        ('9', 'Andrea', 'Snow', 'female', '15.02.1998', 'married', 'ufa karla-marksa 1', 'driver'), 
        ('10', 'Angelica', 'Barnes', 'female', '02.09.1991', 'married', 'omsk karla-marksa 1', 'driver')
    ]
